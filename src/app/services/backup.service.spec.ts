...
describe('BackupService', () => {
    ...
    it('should fail import with wrong password', async () => {
        mockStorage.accounts = [{
            id: '1', issuer: 'Test', label: 'User', secret: 'SECRET', algorithm: 'SHA1', digits: 6, period: 30, type: 'totp' as const, created: 123
        }];
        ...
        await expect(service.importBackup(file, 'wrong-password'))
